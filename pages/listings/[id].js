...
function whatsappLink(phone, title) {
  ...
  const message = encodeURIComponent(
    `Hi, I saw "${title}" on Nyumba and I'm interested. Is it still available?`
  );
    ...
    <div className="page">
      <header className="topbar">
        ...
        <Link href="/search" className="back">
          <i className="ti ti-arrow-left" /> Back to search
        </Link>
      </header>
      ...
      <main>
        ...
        <div className="content">
          <div className="main-col">
            <div className="price">UGX {Number(listing.price_ugx).toLocaleString()}<span>/month</span></div>
            <h1>{listing.title}</h1>
            <div className="area">
            ...
            <div className="contact-card">
              ...
              {listing.landlord?.phone && (
                <>
                  ...
                  <a className="cta call" href={`tel:${listing.landlord.phone}`}>
                    <i className="ti ti-phone" /> Call {listing.landlord.phone}
                  </a>
                </>
              )}
